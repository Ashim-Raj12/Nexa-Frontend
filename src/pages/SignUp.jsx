...
function SignUp() {
  ...
  return (
    ...
    >
      ...
      <form
        className="flex-1 max-w-md min-h-[500px] bg-gradient-to-br from-black/40 to-black/60 backdrop-blur-md shadow-2xl shadow-black/50 rounded-3xl p-8 border border-white/20 animate-slideInRight flex flex-col justify-center items-center gap-6 hover:shadow-cyan-500/50 hover:scale-[1.02] transition-transform duration-300"
        onSubmit={handleSignup}
      >
        <div className="flex flex-col justify-center items-center text-center gap-2">
          <h1 className="text-white text-3xl md:text-4xl font-bold">
            Register to <span className="text-sky-400">NEXA</span>
          </h1>
        ...
        <div className="w-full h-14 border-2 border-white/50 bg-white/10 text-white rounded-xl text-lg relative focus-within:ring-2 focus-within:ring-cyan-400 focus-within:border-cyan-400 transition-all duration-300">
          <FaUser className="absolute top-3 left-4 text-white w-6 h-6" />
          <input
            type="text"
